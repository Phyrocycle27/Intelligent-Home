...
import tk.hiddenname.smarthome.model.error.ApiError
import tk.hiddenname.smarthome.model.error.CustomFieldError
import tk.hiddenname.smarthome.model.error.ValidationError
...
class ExceptionHandlerRestController {
    ...
    @ExceptionHandler(
        AreaNotFoundException::class, DeviceNotFoundException::class, ProcessorNotFoundException::class,
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(
        GpioNotSpecifiedException::class, GpioPinNotSpecifiedException::class,
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ExceptionHandler(
        GpioPinBusyException::class, ProcessorExistsException::class,
